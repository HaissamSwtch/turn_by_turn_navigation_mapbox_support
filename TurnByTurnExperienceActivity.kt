...
import com.example.flutter_android_mapbox_navigation.databinding.MapboxActivityTurnByTurnExperienceBindingBinding
...
//    private val replayProgressObserver = ReplayProgressObserver(mapboxReplayer)
     ...
     */
    private lateinit var binding: MapboxActivityTurnByTurnExperienceBindingBinding
...
//                print("locationMatcherResult.enhancedLocatio ${locationMatcherResult.enhancedLocation}" );
//
//            }
//
            if(navigationLocationProvider.lastLocation != null){
                print("navigationLocationProvider.lastLocation ${navigationLocationProvider.lastLocation}" );
            }
...
//                 mapboxNavigation.unregisterRouteProgressObserver(replayProgressObserver)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = MapboxActivityTurnByTurnExperienceBindingBinding.inflate(layoutInflater)
